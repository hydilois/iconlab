...
;(function (global, factory) {
    ...
    function copyConfig(tot, fromt) {
        var i, prop, val;

        if (!isUndefined(fromt._isAMomentObject)) {
            tot._isAMomentObject = fromt._isAMomentObject;
        }
        if (!isUndefined(fromt._i)) {
            tot._i = fromt._i;
        }
        if (!isUndefined(fromt._f)) {
            tot._f = fromt._f;
        }
        if (!isUndefined(fromt._l)) {
            tot._l = fromt._l;
        }
        if (!isUndefined(fromt._strict)) {
            tot._strict = fromt._strict;
        }
        if (!isUndefined(fromt._tzm)) {
            tot._tzm = fromt._tzm;
        }
        if (!isUndefined(fromt._isUTC)) {
            tot._isUTC = fromt._isUTC;
        }
        if (!isUndefined(fromt._offset)) {
            tot._offset = fromt._offset;
        }
        if (!isUndefined(fromt._pf)) {
            tot._pf = getParsingFlags(fromt);
        }
        if (!isUndefined(fromt._locale)) {
            tot._locale = fromt._locale;
        }
