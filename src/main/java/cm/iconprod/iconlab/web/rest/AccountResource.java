...
import cm.iconprod.iconlab.domain.PersistentToken;
import cm.iconprod.iconlab.domain.User;
import cm.iconprod.iconlab.repository.PersistentTokenRepository;
...
import cm.iconprod.iconlab.web.rest.dto.KeyAndPasswordDTO;
...
public class AccountResource {
        ...
        return userRepository.findOneByLogin(managedUserDTO.getLogin().toLowerCase())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(managedUserDTO.getEmail())
                ...
                .orElseGet(() -> {
                    ...
                    managedUserDTO.getFirstName(), managedUserDTO.getLastName(), managedUserDTO.getEmail().toLowerCase(),managedUserDTO.getPhonenumber(),
                    managedUserDTO.getImage(),
    ...
    public ResponseEntity<String> saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUserInformation(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),userDTO.getPhonenumber()
                    ,userDTO.getImage(),userDTO.getLangKey());
